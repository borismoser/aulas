...
public class Cidade implements Comparable<Cidade> {
	...
	public static Cidade novaCidade(String[] campos) {
		Cidade c = new Cidade(campos);
		return c;
	}

	private Cidade(String uf, String nome, int popTotal, int popMasc, int popFem) {
		this.uf = uf;
		this.nome = nome;
